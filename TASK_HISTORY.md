...
> 本文件收纳从 TASK_STATE.md 移出的早期任务记录，按归档批次追加。
> 本批次收纳范围：2026-06-11 至 2026-07-19（另含原文件尾部乱序追加的 2026-07-06、2026-07-10 交接块）。
> 归档时间：2026-07-31；仅搬运、内容未改写。最新任务状态见 TASK_STATE.md。
...
> 本批次收纳范围：2026-07-20 至 2026-07-31（含文件中部乱序的 07-24/07-25 条目群，均落在收纳范围内，无需摘回）。
> 归档时间：2026-08-06；仅搬运、内容未改写。最新任务状态见 TASK_STATE.md。
