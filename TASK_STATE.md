...
- 验证：全量测试 174 文件 / 1855 项、Node/Renderer 类型检查、生产构建、OKF strict validate 与 180 天 audit 均通过；构建产物已确认注入版本号 2.21.0。待提交并推送 master，再推送 v2.21.0 标签交由 GitHub Actions 构建发布。
