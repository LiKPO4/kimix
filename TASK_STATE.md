...
## 当前目标
v2.7.105 待验收：文件更改卡片按规范化路径合并同一文件，避免重复文件行共用展开/收起状态。

## 当前版本
**v2.7.105** — 三处同步：`package.json` + `src/components/layout/Sidebar.tsx` + `src/components/settings/SettingsPanel.tsx`。
