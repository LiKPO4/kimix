...
- Implementation state: Kimix v2.12.28, light theme, idle session, model menu open at 1280 x 800.
...
- Remaining visual check: v2.12.27 exposed incorrect model attribution; v2.12.28 separates official per-turn usage from the active runtime model and requires another user-side functional pass.
