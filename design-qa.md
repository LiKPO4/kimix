...
- Implementation state: Kimix v2.12.27, light theme, idle session, model menu open at 1280 x 800.
...
- Remaining visual check: v2.12.25 was user-tested; the v2.12.27 event ownership and lazy Provider compatibility corrections require another user-side functional pass.
