...
### CLI 0.10.0 tag + node-sdk 0.8.0 重跑结论

2026-06-05 重跑确认：vendored SDK 来源为官方 `@moonshot-ai/kimi-code@0.10.0` tag，研究仓库 HEAD 为 `12d062d48e32f8c19626b7236278cba598e60c37`，`packages/node-sdk` 版本为 `0.8.0`。本机已安装 `kimi 0.10.0`，`kimi doctor` 子命令可用；SDK 新增/确认 `Session.reloadSession()`、`KimiHarness.reloadSession()`、`Session.activateSkill()`、`createKimiConfigRpc()` 等能力。Kimix 本轮优先接入配置诊断、配置变更后的空闲会话 reload，以及 Windows Git Bash 缺失的提前提示；`/goal next` 仍属于 TUI/实验目标队列，暂不接入 Kimix 长程任务主线。
...
```text
{
  ...
  "timedOut": false,
  "durationMs": 47,
  "stdout": " M AGENTS.md\n M TASK_STATE.md\n M electron/kimiCodeHost.ts\n M electron/main.ts\n M electron/preload.ts\n M electron/types/ipc.ts\n M package.json\n M src/components/chat/MarkdownRenderer.tsx\n M src/components/layout/SearchOverlay.tsx\n M src/components/layout/SessionToolbar.tsx\n M src/components/layout/Sidebar.tsx\n M src/components/layout/SkillsPanel.tsx\n M src/components/layout/TopMenuBar.tsx\n M src/components/settings/SettingsPanel.tsx\n M src/hooks/useEventStream.ts\n M src/main.tsx\n M src/stores/sessionStore.ts\n M src/types/ui.ts\n M src/utils/kimiCodeSendRetry.ts\n M vendor/kimi-code-sdk/index.mjs\n",
  "stderr": ""
}
```
### 通过：kimi --version
...
```text
{
  ...
  "timedOut": false,
  "durationMs": 40,
  "stdout": "12d062d 2026-06-04 21:45:01 +0800 ci: release packages (#390)",
  "stderr": ""
}
```
...
```text
{
  "sessionId": "session_ba12b895-ee1e-4da0-ab6e-233df9bacf44",
  "workDir": "C:/Users/ADMINI~1/AppData/Local/Temp/kimix-kimi-code-sdk-probe/work",
  "model": "kimi-code/kimi-for-coding",
  "sessionDir": "C:\\Users\\Administrator\\.kimi-code\\sessions\\wd_work_bc69271920cd\\session_ba12b895-ee1e-4da0-ab6e-233df9bacf44",
  "wirePath": "C:\\Users\\Administrator\\.kimi-code\\sessions\\wd_work_bc69271920cd\\session_ba12b895-ee1e-4da0-ab6e-233df9bacf44\\agents\\main\\wire.jsonl",
  "wireExists": true
}
```
...
{
  "sessionId": "session_ba12b895-ee1e-4da0-ab6e-233df9bacf44",
  "sessionCountBeforeSteer": 6,
  "sessionCountAfterSteer": 6,
  "prompt": {
    "turnId": 1,
    "eventCount": 435,
    "firstEventMs": 31,
