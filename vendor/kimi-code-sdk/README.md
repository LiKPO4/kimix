...
| Official base | `f6ee44e42641498f26635eec2e6799d13372885c` (tag `@moonshot-ai/kimi-code@0.35.0`) |
...
| node-sdk version | `0.16.0` |
| Validated against CLI | installed `0.35.0` / source tag `@moonshot-ai/kimi-code@0.35.0` |
