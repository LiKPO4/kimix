...
export type AppSettings = {
  ...
  themePalette: "warm-paper" | "neutral-gray" | "soft-green" | "warm-orange" | "custom" | `kimi:${string}` | `ui-style:${string}`;
...
export type KimiCodePromptRequest = {
  sessionId: string;
  content: string;
  /** Stable client-owned prompt identity; generated by the main process when omitted. */
  promptId?: string;
