...
## 2026-06-20
* **Runtime routing**: Added the slash command rule that official Kimi Code commands route through Server/SDK prompt dispatch first, while Kimix-only commands stay local and SDK-era handlers act as fallback.
