...
* [Kimi Code Subagent Model Pool](kimi-code-subagent-model-pool.md) - Official [secondary_model] pool config, validation, and Kimix integration caveats through 0.41.0.
