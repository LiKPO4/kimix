...
timestamp: "2026-07-28T17:55:00+08:00"
---
...
repairs an already-persisted protocol artifact only when two `active-draft:`
materializations have the same room/message/turn identity and the exact same
body/thinking payload; ordinary Assistant messages and identical prose from
different turns are never content-deduplicated. SDK-route deltas carry no
offset and keep the legacy path.
