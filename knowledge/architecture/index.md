...
* [Interface Style System](interface-style-system.md) - How color themes stay independent from role-based shape, depth, focus, interaction styling, popup/modal/inspector shell ownership, quiet parent-row reveal actions, and bounded imported metadata.
