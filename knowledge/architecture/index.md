...
* [Runtime Routing](runtime-routing.md) - How Kimix routes sessions between the official Server and the clean Kimi Code 0.31 SDK fallback while preserving tri-state runtime authority, authoritative sidebar activity, structured attachment transport, session-model ownership, immutable prompt models, snapshot message identity, prompt-completion delivery barriers, isolated Coding/monthly quota credentials, neutral usage metadata, bounded Swarm detail presentation, and process history.
