...
timestamp: "2026-07-01T23:00:00+08:00"
---
...
* Startup and session switching use bottom-first rendering instead of hiding the entire chat until canonical history is ready. Kimix initially renders a small eager-Markdown tail aligned to the composer. When official history hydration settles, older visible-range items are prepended in a layout commit while bottom alignment is preserved. This provides immediate useful content without exposing cached-bottom, placeholder-bottom, or whole-page blank states.
