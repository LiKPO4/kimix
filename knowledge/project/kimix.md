...
timestamp: "2026-07-01T22:50:00+08:00"
---
...
* Startup session restoration has separate mirror-ready and canonical-history-ready phases. The active cached session may populate navigation immediately, but its chat stream stays hidden while official history hydration is pending. Once hydration succeeds or fails, Kimix performs a layout-phase bottom alignment before revealing the stream, preventing a visible cached-bottom-to-canonical-bottom jump.
