...
timestamp: "2026-07-01T22:55:00+08:00"
---
...
* Startup session restoration has separate mirror-ready, canonical-history-ready, and final-layout-ready phases. The active cached session may populate navigation immediately, but its chat stream stays hidden while official history hydration is pending. During the hidden/initial-settle phase, visible-range long Markdown renders eagerly instead of using estimated offscreen placeholders. Kimix reveals the stream only after layout-phase bottom alignment against the real Markdown DOM, preventing cached-bottom and placeholder-bottom jumps.
