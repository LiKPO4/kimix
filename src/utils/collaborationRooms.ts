...
export function createSyntheticPrimaryAgent(
  ...
  return {
    ...
    subagentModelAlias: session.subagentModelAlias,
    subagentThinkingEffort: session.subagentThinkingEffort,
    subagentRoutingDesired: session.subagentRoutingDesired,
    subagentForceInvoke: session.subagentForceInvoke,
...
function reconcileLegacyPrimaryWrite(session: Session, collaboration: CollaborationState): CollaborationState {
  ...
  const nextPrimary: RoomAgent = {
    ...
    subagentModelAlias: legacyPrimary.subagentModelAlias,
    subagentThinkingEffort: legacyPrimary.subagentThinkingEffort,
    subagentRoutingDesired: legacyPrimary.subagentRoutingDesired,
    subagentForceInvoke: legacyPrimary.subagentForceInvoke,
...
export function mirrorPrimaryAgentToLegacySession(session: Session): Session {
  ...
  return {
    ...
    subagentModelAlias: primary.subagentModelAlias,
    subagentThinkingEffort: primary.subagentThinkingEffort,
    subagentRoutingDesired: primary.subagentRoutingDesired,
    subagentForceInvoke: primary.subagentForceInvoke,
